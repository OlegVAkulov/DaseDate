...
//        pw.println("</form>");
        pw.println("</body>");
        pw.println("</head>");
        Cookie cookie1 = new Cookie("name", "<strong>User Name</strong>:<input type=\"text\" name=\"name\"><br>");
        Cookie cookie2 = new Cookie("surname", "<strong>User Surname</strong>:<input type=\"text\" name=\"surname\"><br>");
        Cookie cookie3 = new Cookie("age", "<strong>User Age</strong>:<input type=\"number\" name=\"age\"><br>");
